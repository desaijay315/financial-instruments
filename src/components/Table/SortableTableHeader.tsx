...
import { ASC, ASSET_CLASS, PRICE, TICKER, UP_ARROW, DOWN_ARROW } from '../../utils/constants';
...
const SortableTableHeader: React.FC<SortableTableHeaderProps> = ({ sortConfig, toggleSort }) => {
  return (
    <tr>
